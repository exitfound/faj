...
- Git, с помощью которого вами будет скачан репозиторий из Github.
...
- **jenkins-docker-compose.yaml:** Файл для непосредственного запуска Jenkins на базе образа, собранного с помощью Dockerfile.
